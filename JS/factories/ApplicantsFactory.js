app.factory('ApplicantsFactory', function($http){
    ...
    factory.update_cv = function(data){
        var promise = $http({
            url:'./FUNCTIONS/Applicants/update_cv.php',
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            transformRequest: function(obj) {
                var str = [];
    ...
    factory.check_duplicate = function(data){
        var promise = $http({
            url:'./FUNCTIONS/Applicants/check_duplicate.php',
            method: 'POST',
            headers: {'Content-Type': 'application/x-www-form-urlencoded'},
            transformRequest: function(obj) {
                var str = [];
